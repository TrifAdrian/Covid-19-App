...
public class Adapter extends RecyclerView.Adapter<com.example.covid_19_app.Adapter.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date1.setText(notesList.get(position).getDate1());
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("date1", notesList.get(position).getDate1());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView title, description, date1;
